function continuation(kappa, massRange)
    ...
    initialDataFile = sprintf('../../../../PatternFormation_Data/PeriodicInitialGuess/initialSolution_kappa_%d.mat',floor(10*kappa));
...
%         sol = chemSolve(sol,L,kappa,masses(i+1),bvp);
    ...
    filename = sprintf('../../../../PatternFormation_Data/PeriodicEquilibria/equilibriumSolutions_kappa_%d_mass_%d_%d.mat',floor(10*kappa),floor(10*masses(1)),floor(10*masses(end)));
