%% HeatEqn1D.m
% Simulates a modified heat equation with a specified initial condition and
% Neumann boundary conditions using an implicit Euler's method
%
%   Modified Heat Equation: U_t = U_xx + F(U)
% 
% HeatEqn1D(U0, X, F)
...
%       e.g. [x_0, x_L]
%   F:  A function handle that takes in the heat profile (a vector of
%       length N) and returns another vector of the same length

function ModifiedHeatEqn1D(U0,X,Func)
